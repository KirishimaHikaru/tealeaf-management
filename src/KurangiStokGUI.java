...
class KurangiStokGUI {
    KurangiStokGUI() {
        JFrame frame = new JFrame("Kurangi Stok");
        ...
        btnSimpan.addActionListener(e -> {
            ...
            if (jenis != null && !txtJumlah.getText().isEmpty()) {
                ...
                if (StokManager.kurangiStok(jenis, jumlahKg)) {
                    JOptionPane.showMessageDialog(frame, "Stok berhasil dikurangi!");
                } else {
